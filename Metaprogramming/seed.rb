module Seed
  ...
  def seed_carriages
    @unused_carriages << @carriage1 = CargoCarriage.new('c143', capacity: 50)
    @unused_carriages << @carriage2 = CargoCarriage.new('c221', capacity: 50)
    @unused_carriages << @carriage3 = CargoCarriage.new('c342', capacity: 40)
    @unused_carriages << @carriage4 = CargoCarriage.new('c475', capacity: 45)
    @unused_carriages << @carriage5 = CargoCarriage.new('c532', capacity: 50)
    @unused_carriages << @carriage6 = CargoCarriage.new('c675', capacity: 40)
    @unused_carriages << @carriage7 = PassengerCarriage.new('p012', seats: 80)
    @unused_carriages << @carriage8 = PassengerCarriage.new('p220', seats: 90)
    @unused_carriages << @carriage9 = PassengerCarriage.new('p039', seats: 80)
    @unused_carriages << @carriage10 = PassengerCarriage.new('p409', seats: 80)
    @unused_carriages << @carriage11 = PassengerCarriage.new('p564', seats: 100)
    @unused_carriages << @carriage12 = PassengerCarriage.new('p064', seats: 100)
